...
%%{
    ...
    action save_scheme
    {
        uri->set_scheme(std::string(mark, fpc - mark));
        mark = NULL;
    }
    ...
    action save_userinfo
    {
        if(mark) {
            ...
            uri->set_user(std::string(mark, fpc - mark));
        }
        mark = NULL;
    }
    action save_host
    {
        if (mark != NULL) {
            //std::cout << std::string(mark, fpc - mark) << std::endl;
            uri->set_host(std::string(mark, fpc - mark));
        }
    }
    ...
    {
            //std::cout << std::string(mark, fpc - mark) << std::endl;
        uri->set_path(std::string(mark, fpc - mark));
        mark = NULL;
    }
...
# add (any -- ascii) support chinese
    ...
    {
        //std::cout << std::string(mark, fpc - mark) << std::endl;
        uri->set_query(std::string(mark, fpc - mark));
        mark = NULL;
    }
    action save_fragment
    {
        //std::cout << std::string(mark, fpc - mark) << std::endl;
        uri->set_fragment(std::string(mark, fpc - mark));
        mark = NULL;
    }
