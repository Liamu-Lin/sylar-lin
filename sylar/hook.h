...
typedef ssize_t (*send_fun)(int sockfd, const void *msg, size_t len, int flags);
extern send_fun send_f;
typedef ssize_t (*sendto_fun)(int sockfd, const void *msg, size_t len, int flags, const struct sockaddr *to, socklen_t tolen);
