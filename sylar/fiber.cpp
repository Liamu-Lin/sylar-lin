...
void swap_fiber(Fiber* old_fiber, Fiber* new_fiber);
...
void FiberMem::change_occupier(Fiber* new_occupier){
...
void swap_fiber(Fiber* old_fiber, Fiber* new_fiber){
    ...
    Fiber* b_new_fiber = t_fiber_env.swap_in_fiber_;
    Fiber* b_old_fiber = t_fiber_env.swap_out_fiber_;
